...
from .helpers import create_image, create_admin
...
class ToolsTestCase(TestCase):
    def setUp(self):
        ...
        self.image = Image.objects.create(owner=self.admin,
                                     original_filename=self.image_name,
                                     file=self.file)
        self.clipboard = Clipboard.objects.create(user=self.admin)
    ...
    def test_move_to_clipboard_works(self):
        ...
        file2 = Image.objects.create(owner=self.admin,
                                     original_filename='file2',
                                     file=self.file)
        file3 = Image.objects.create(owner=self.admin,
