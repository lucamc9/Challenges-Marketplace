...
class FolderAdmin(PrimitivePermissionAwareModelAdmin):
    ...
    def directory_listing(self, request, folder_id=None, viewtype=None):
        ...
        context.update({
            ...
            'can_make_folder': request.user.is_admin or (folder.is_root and settings.FILER_ALLOW_REGULAR_USERS_TO_ADD_ROOT_FOLDERS) or permissions.get("has_add_children_permission"),
        })
